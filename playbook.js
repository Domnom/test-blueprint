...
playbook("LOOK IVE CHANGED TODO - Get the name from github url")
	.addCategory("TODO - Create a category name")
		.addScene("TODO - Create a scene name")
			...
			.addStep("step-2")
				.addCode("step-2/code/features/cool/CoolFeature.hbs")
				.withTime({
					"start" : 0,
					"duration" : 100
				})
			.addStep("step-3")
				.addCode("step-3/code/features/cool/CoolFeature.hbs")
				...
				.addCode("step-3/code/service/ValidationService.hbs")
				.withTime({
					"start" : 100,
					"duration" : 100
				})
			.addStep("step-4")
				.addCode("step-4/code/features/cool/CoolFeature.hbs")
