...
module.exports = step("step-03")
					...
					.addCode("/code/backend/server/src/app.module.hbs", "backend/server/src/app.module.ts")
						.withPartial("partial_1", "step-03/code/backend/server/src/app.module_partials/partial_1.hbs", 0, 100)
						.withPartial("partial_2", "step-03/code/backend/server/src/app.module_partials/partial_2.hbs", 100, 100)
					.withTime({
						"start" : 0,
						"duration" : 100
					})
